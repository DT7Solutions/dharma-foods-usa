...
import swethaLogo from '@/assets/swethatelugufoods-aboutus-page-img_720x.webp';
          ...
          <div className="container mx-auto px-4 lg:px-8">
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                  ...
                  <div className="relative">
                      <div className="relative bg-gradient-to-br from-secondary/10 via-primary/5 to-accent/10 rounded-3xl text-center">
